...
module RISCV_SingleProcessor(
    ...
    // Extra Stuff, Not needed for Single Cycle
    wire PCWrite, ID_EX_Control_Mux_Out, Is_Greater;
    ...
    Control_Unit CU(opcode, ALUOp, Branch, MemRead, MemtoReg, MemWrite, ALUSrc, RegWrite, ID_EX_Control_Mux_Out);
    Register_File RF(WriteData, RS1, RS2, RD, RegWrite, clk, reset, ReadData1, ReadData2, reg1, reg2, reg3);
