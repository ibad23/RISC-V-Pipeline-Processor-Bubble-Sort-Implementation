...
module RISCV_SCProcessor(
    ...
    Mux_2x1 BRANCH(Out1, EX_MEM_Adder_out, (EX_MEM_Branch & EX_MEM_Zero), PC_in); // Branching MUX this has problems.
    Program_Counter PC(clk, reset, PC_in, PC_out, PCWrite);
    Instruction_Memory IM(PC_out, Instruction); 
    
    IF_ID Pipeline1(clk, reset, 
    ...
    ALU64 ALU(Forward_A_Output, Data_Out, Operation, ALU_Result, Zero);
    
    EX_MEM Pipeline3(clk, reset, 
            ID_EX_RegWrite, ID_EX_MemRead, ID_EX_MemtoReg, ID_EX_MemWrite, ID_EX_Branch, // input control signals
            Adder_out, ALU_Result, BranchSelect, Forward_B_Output, ID_EX_RD,  // inputs
